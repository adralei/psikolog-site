...
export default function Home() {
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="flex gap-3 mt-4">
            <a href="/iletisim" className="px-5 py-3 bg-accent text-white rounded-md">Randevu Al</a>
            <a href="/hizmetler" className="px-5 py-3 border rounded-md">Hizmetler</a>
          </div>
        </div>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="w-40 h-40 rounded-full overflow-hidden shadow-lg">
            {/* Placeholder görsel - istersen gerçek url koy */}
      ...
      {/* Kısa Hakkında veya Eğitimler bölümü (anchor ile erişim) */}
